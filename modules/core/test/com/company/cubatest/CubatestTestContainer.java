...
public class CubatestTestContainer extends TestContainer {

    public CubatestTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/cubatest/app.properties",
    ...
    public static class Common extends CubatestTestContainer {

        public static final CubatestTestContainer.Common INSTANCE = new CubatestTestContainer.Common();
